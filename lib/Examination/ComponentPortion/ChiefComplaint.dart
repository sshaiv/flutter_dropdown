...
class ChiefcomplaintModel {
  ...
  factory ChiefcomplaintModel.fromJson(Map<String, dynamic> json) => ChiefcomplaintModel(
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<ChiefcomplaintModel> medicines = data.map((item) => ChiefcomplaintModel.fromJson(item)).toList();
        ...
        child: Column(
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              child: ListTile(
                title: Text(selectedValue ?? 'Select Chief Complaint',style: TextStyle(fontSize: 10),),
