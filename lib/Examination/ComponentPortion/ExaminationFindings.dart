...
class ExaminationfindingsModel {
  final double itemid;
  final String itemname;

  ExaminationfindingsModel({
    required this.itemid,
    required this.itemname,
  });

  factory ExaminationfindingsModel.fromJson(Map<String, dynamic> json) => ExaminationfindingsModel(
    itemid: json["itemid"].toDouble(),
    itemname: json["itemname"],
  );
}

class Examinationfindings extends StatefulWidget {
  const Examinationfindings({super.key});

  @override
  State<Examinationfindings> createState() => _ExaminationfindingsState();
}

class _ExaminationfindingsState extends State<Examinationfindings> {
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<ExaminationfindingsModel> medicines = data.map((item) => ExaminationfindingsModel.fromJson(item)).toList();
        ...
        child: Column(
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              child: ListTile(
                title: Text(selectedValue ?? 'Select Examinationfindings',style: TextStyle(fontSize: 10),),
