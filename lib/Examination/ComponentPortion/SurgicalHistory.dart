...
class SurgicalhistoryModel {
  ...
  factory SurgicalhistoryModel.fromJson(Map<String, dynamic> json) => SurgicalhistoryModel(
...
class Surgicalhistory extends StatefulWidget {
  const Surgicalhistory({super.key});

  @override
  State<Surgicalhistory> createState() => _SurgicalhistoryState();
}
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<SurgicalhistoryModel> medicines = data.map((item) => SurgicalhistoryModel.fromJson(item)).toList();
        ...
        child: Column(
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              child: ListTile(
                title: Text(selectedValue ?? 'Select Surgicalhistory',style: TextStyle(fontSize: 10),),
