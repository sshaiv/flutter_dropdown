...
class FamilyhistoryModel {
  ...
  factory FamilyhistoryModel.fromJson(Map<String, dynamic> json) => FamilyhistoryModel(
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<FamilyhistoryModel> medicines = data.map((item) => FamilyhistoryModel.fromJson(item)).toList();
        ...
        child: Column(
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              child: ListTile(
                title: Text(selectedValue ?? 'Select Familyhistory',style: TextStyle(fontSize: 10),),
